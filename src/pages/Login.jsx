...
import { loginUserthunk } from '../reduxlogic/userslice';
import { useSelector } from 'react-redux';
import { useDispatch } from 'react-redux';
import { Navigate } from 'react-router-dom';
import {useNavigate} from 'react-router-dom'
import { login } from '../reduxlogic/userslice';
// component starts here
export async function loaderUser({user}){
...
// const dispatch= useDispatch();
  const output= useSelector(state=>state.user.user)
// console.log(output)
// useEffect(()=>{
//   if(data){
//     dispatch(login(data))
